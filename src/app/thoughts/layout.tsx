...
export default function ThoughtsLayout({
  ...
  return (
    <div className="min-h-screen pt-24 px-6 max-w-4xl mx-auto pb-20 font-[family-name:var(--font-space)]">
        <Link href="/thoughts" className="inline-flex items-center gap-2 text-xs font-bold text-blue-600 hover:text-blue-800 transition-colors uppercase tracking-wider mb-12 no-underline">
            <ArrowLeft className="w-4 h-4" /> Return to Thoughts
        </Link>
